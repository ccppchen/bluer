        ...
        <template v-if="nav">
          ...
          <div :class="{'show-navcontent': isShow}" class="j-navcontent">
            <ul class="ul-nav flex-m">
              <li><a :href="$h5BaseUrl + '/page/view_Index.html?pageNumber=1&pageSize=5'"><i class="iconfont ihome"></i><p>首页</p></a></li>
              <li><a :href="$h5BaseUrl + '/page/searchlist.html'"><i class="iconfont isearch"></i><p>搜索</p></a></li>
              <li><a :href="$h5BaseUrl + '/product/SearchCategorylist.html'"><i class="iconfont class"></i><p>分类</p></a></li>
              <li><a :href="$h5BaseUrl + '/sale/shoppingcart/view_shopping_cart.html'"><i class="iconfont shop-car"></i><p>购物车</p></a></li>
              <li><a :href="$h5BaseUrl + '/member/view_memberIndex.html'"><i class="iconfont iuser"></i><p>我的i百联</p></a></li>
            </ul>
          </div>
        </template>
      </div>
